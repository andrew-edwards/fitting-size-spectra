# fitMLEbinConfXmin16.r - re-running with xmin=16, using fitting-size-spectra
#  version. 18th May 2018.
...
#  22th October 2015 (The Future [as in Back To...]).
...
for(binTypeInd in 1:binTypes)
  {
  postscript(paste0("fitMLEbinConfXmin16", binType[[binTypeInd]], ".eps"),
...
postscript("fitMLEhistsXmin16.eps",
           height = figheight, width = figwidth,
           horizontal=FALSE,  paper="special")
...
postscript("fitMLEconfsXmin16.eps",
           height = figheight, width = figwidth,
           horizontal=FALSE,  paper="special")
