# fitMLEbinConfCutOff16.r - updating this (just pathnames) from the 2016 version,
#  rather than the new fitting-size-spectra/ fitMLEbin one, since the 2016
#  version had quite a few changes. 18th May 2018.

# fitMLEbinConfCutOff16.r - histogram of MLE values and confidence intervals with
#  xmin=1 but values cut off at 16.
#  9th August 2016.
# fitMLEbinConfXmin16.r - histogram of MLE values and confidence intervals with
#  xmin=16. 20th July 2016.
...
for(binTypeInd in 1:binTypes)
  {
  postscript(paste0("fitMLEbinConfCutOff16", binType[[binTypeInd]], ".eps"),
...
postscript("fitMLEconfsCutOff16.eps",
           height = figheight, width = figwidth,
           horizontal=FALSE,  paper="special")
...
# insetMat[3, 1] = 0.1  # Not needed for xmin=16 figure.
