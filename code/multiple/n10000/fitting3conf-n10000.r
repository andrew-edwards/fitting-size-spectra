# fitting3conf-n10000.r - for samples sizes of n=10000, just adapting
#  default figure (n=1000), rather than bMinus25 or others,  so
#  that axes can hopefully remain the same as main figure in manuscript.
#  2nd May 2016.
...
postscript("fitting3conf-n10000.eps", height = figheight, width = figwidth,
...
postscript("fitting3confMLEfix-n10000.eps", height = 0.8*figheight,
           width = 0.8*figwidth,
           horizontal=FALSE,  paper="special")  
