...
postscript("fitting3rep-bMinus15.eps", height = figheight, width = figwidth,
...
postscript("fitting3repMLEfix-bMinus15.eps", height = 0.8*figheight, width = 0.8*figwidth,
           horizontal=FALSE,  paper="special")  
par(omi = c(0.12, 0.05, 0.12, 0.0))      # outer margins in inches
par(mfrow=c(2,1)) #7,1))
...
save.image(file = "fitting3rep-bMinus15.RData")
